...
if [ -f $existingOTAjson ]; then
	...
	"response": [
		{
			...
			"device": "'$device'",
			"filename": "'$filename'",
			"download": "https://sourceforge.net/projects/OrionOs/files/'$1'/'$v_max'.x/'$3'/download",
			"timestamp": '$timestamp',
			"md5": "'$md5'",
			"sha256": "'$sha256'",
			"size": '$size',
	...
	echo 'Consider adding official support by reading the documentation at https://github.com/OrionOs-prjkt/android_vendor_OrionOTA/blob/14.0/README.md'
fi
